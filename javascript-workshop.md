...
<body>
    <!-- Inline JavaScript -->
    <button onclick="alert('67030116 นายนิธิ ทิพย์ประเสริฐ')">ปุ่มที่ 1</button>
...
<body>
    <script>
        let studentnumber = "67030116";
        let name = "นิธิ ทิพย์ประเสริฐ";
        const midtermscores = 70;
        const finalscore = 60;

        let student ={
            studentnumber: 67030116,
            name: "นิธิ ทิพย์ประเสริฐ",
...
```
[![{F3684C0E-CBE2-4868-9BDD-5BABB0B7545A}](https://github.com/user-attachments/assets/4cb1e508-f708-4a92-8fcb-b95892be9532)
]
...
```
[![{EABB8C32-608D-4825-A6F3-07C4420089F0}](https://github.com/user-attachments/assets/da6295fa-3620-4b20-a8af-9c2b0d16cb47)
]
